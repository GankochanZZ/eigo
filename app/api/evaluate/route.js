...
【フィードバックの構成と見やすさ】
1. 100点満点でない場合は、「どの基準が満たされていなかったのか」をしっかりと文字数を割いて具体的に指摘・解説してください。
2. 見やすさのため適宜「・」の箇条書きや改行\\nを使用し、読みやすく文章を整理してください。
3. 文末の余計な段落や、励まし・フォローの言葉は一切不要です。（純粋に採点の解説だけを行ってください）
4. トーンは的確な指導スタイルとし、絶対にJSON以外のテキストは出力しないでください。
